...
Files: public/assets/ct_scan_lung.glb [16.25MB] > /Users/flatironschool/Development/projects--2024/point-cloud-segmentation-demo/ct_scan_lung-transformed.glb [16.24MB] (0%)
...
export default function CtScanLung(props) {
	...
	const { nodes, materials } = useGLTF(process.env.PUBLIC_URL + '/assets/ct_scan_lung-transformed.glb')
...
useGLTF.preload(process.env.PUBLIC_URL + '/assets/ct_scan_lung-transformed.glb')
